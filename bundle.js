...
// Function to remove the element with ID "logo"
function removeLogo() {
...
// Initialize the observer and the target element to be observed
...
const config = {
  attributes: false,
  childList: true,
  subtree: true, // observe the target and all its descendants
};

// Target node to observe
const targetNode = document.getElementById('main-background'); // you can specify a more specific element if you know where the logo will be added

// Start observing
observer.observe(targetNode, config);

// You can also try to remove the logo initially, just in case it already exists
removeLogo();
